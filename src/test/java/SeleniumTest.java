...
public class SeleniumTest {
    ...
    public void shouldReturnCorrectDataAfterFollowingTheLinkRubberDucks() {
        ...
        driver.findElement(By.cssSelector("nav#site-menu [href='https://litecart.stqa.ru/en/rubber-ducks-c-1/']")).click();
        WebElement pageTitle = driver.findElement(By.cssSelector("h1.title"));
        softAssert.assertEquals(driver.getTitle(), testTitleRubberDucks,"1111");
        softAssert.assertEquals(pageTitle.getText(),textTestRubberDucks,"222");
    ...
    public void shouldReturnCorrectDataAfterFollowingTheLinkSubcategory() {
        ...
        actions.moveToElement(driver.findElement(By.cssSelector("nav#site-menu [href='https://litecart.stqa.ru/en/rubber-ducks-c-1/']"))).perform();
    ...
    public void shouldReturnTheCorrectDataForTheTransitionToTheHomeLink() {
        ...
        WebElement webElementPictureHome = driver.findElement(By.xpath("//*/img[@src='/images/slides/1-lonely-duck.jpg']"));
